...
class QuickBubbleService : Service() {
    ...
    private fun runQuickEncrypt() {
        ...
        CipherClipboard.write(this, "CipherKey", encrypted)
    ...
    private fun runQuickDecrypt() {
        ...
        if (result != null) {
            CipherClipboard.write(this, "CipherKey plain", result.plaintext)
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentTitle("CipherKey bubble active")
...
private object CipherDetectorSafe {
    fun looksLikeCipher(text: String): Boolean =
        com.example.cipher.CipherDetector.looksLikeCipher(text)
}
